<template>
    <div>
        <section class="page-header" style="background-image: linear-gradient(120deg, rgb(38, 144, 249), rgb(252, 45, 45)); color: rgb(255, 255, 255);">
            ...
            <h1 class="project-name">康小源</h1>
            <h2 class="project-tagline">欢迎来到康小源的个人博客。</h2>
            <a :href="'https://github.com/kangjinyuan'" class="btn" target="_blank">GitHub主页</a>
                ...
                <el-row>
                    ...
                    <el-col :span="4" style="text-align: right;">
                        ...
                        <div style="color:#606266;">
                            <i class="el-icon-location"></i>&nbsp;kangjinyuan
                            <br>
                        </div>
                    </el-col>
                    <el-col :span="2" style="text-align: center;">
                        <img v-popover:bigAvatar src="https://avatars1.githubusercontent.com/u/27798999?s=60&v=4" style="margin-top: 4px;margin-right: 10px;width:52px; height:52px; border-radius:5px; border: 1px solid #EBEEF5"
                        />
                        <el-popover ref="bigAvatar" placement="top-start" title="kangjinyuan" width="200" trigger="hover">
                            <i class="el-icon-star-on"></i>&emsp;kangjinyuan
                            <br>
                            <i class="el-icon-location"></i>&emsp;kangjinyuan
                            <br>
                            <img src="https://avatars1.githubusercontent.com/u/27798999?s=60&v=4" style="width: 200px;height: 200px;">
                        </el-popover>
                    </el-col>
                </el-row>
    ...
    export default {
        ...
        methods: {
            selectTopbar(index) {
                ...
                switch (index) {
                    case "#githubHome":
                        window.open('https://github.com/kangjinyuan')
                        break
                    case "#blog":
                        if (this.blog) {
